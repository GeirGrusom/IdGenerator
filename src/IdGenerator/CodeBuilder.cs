...
namespace IxSoftware.Generators
{
    internal static class CodeBuilder
    {
        ...
        public static void AddPreamble(this StringBuilder builder, StructInfo structInfo)
        {
            string line;
            if(structInfo.Comparable == IsComparable.Comparable)
            {

                line = $@"
// This file was generated by a tool. Changes may be overwritten.

namespace {structInfo.DeclaredSymbol.ContainingNamespace}
{{
    public readonly partial struct {structInfo.Identifier} :
        System.Numerics.IEqualityOperators<{structInfo.Identifier}, {structInfo.Identifier}, bool>,
        System.Numerics.IComparisonOperators<{structInfo.Identifier}, {structInfo.Identifier}, bool>
    {{
";
            }
            else
...
namespace {structInfo.DeclaredSymbol.ContainingNamespace}
{{
    public readonly partial struct {structInfo.Identifier} : System.Numerics.IEqualityOperators<{structInfo.Identifier}, {structInfo.Identifier}, bool>
    {{
";
        ...
        public static void AddConstructor(this StringBuilder builder, StructInfo structInfo)
        {
            builder.AppendLine(@$"
        private {structInfo.Identifier}({structInfo.TypeName} value)
        {{
            this.{structInfo.Value} = value;
        }}

        public static explicit operator {structInfo.TypeName}({structInfo.Identifier} value) => value.{structInfo.Value};

        public static implicit operator {structInfo.Identifier}({structInfo.TypeName} value)
...
" : $@"
        ...
        public static void AddEquals(this StringBuilder builder, StructInfo structInfo)
        {
            if (IsString(structInfo.TypeName))
            {
            ...
            {
                if (structInfo.IsFieldReferenceType)
                {
            ...
            string equalsType = structInfo.IsNullableEnabled ? "object?" : "object";

            builder.Append(@$"

        public override bool Equals({equalsType} obj) => obj is {structInfo.Identifier} other && Equals(other);
");
...
");
        ...
        public static void AddToString(this StringBuilder builder, StructInfo structInfo)
        {
            if (string.Equals(structInfo.TypeName, "global::System.DateTime") || string.Equals(structInfo.TypeName, "global::System.DateTimeOffset"))
            {
